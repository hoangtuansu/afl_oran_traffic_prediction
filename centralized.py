...
for sim in sim_runs:
    ...
    while True:
        ...
        if use_min_loss:
            ...
            logging.info("Loss of latest weight value: " + str(loss_latest))
        ...
        logging.info('Time for one local iteration:', time_one_iteration_all)
